...
def feature_from_result(stock_id, trade_date, version, data):
    ...
    return {
        ...
        "vol_ratio_20": _safe_round(_vol_ratio(volumes, 20), 4),
        "breakout_distance": _safe_round(result.get("breakout_distance"), 4),
        "breakout_distance_20": _safe_round(result.get("breakout_distance_20"), 4),
        "breakout_distance_60": _safe_round(result.get("breakout_distance_60"), 4),
...
def feature_from_signal_row(row):
    ...
    return {
        ...
        "vol_ratio_20": _safe_round(row.get("volume_ratio_20"), 4),
        "breakout_distance": _safe_round(row.get("breakout_distance_20"), 4),
        "breakout_distance_20": _safe_round(row.get("breakout_distance_20"), 4),
        "breakout_distance_60": _safe_round(row.get("breakout_distance_60"), 4),
