...
- git completion passed 後，若本輪有更新 `DISPATCH.md` / `CURRENT_STATE.md`，final 前必須跑 `tools/cao_agent/check_architect_closeout_gate.sh`，確認看板與短上下文不再殘留 pending commit / push / completion gate 語句。
