...
- task_md_task_id: `pm-20260604-v20.4.42-unheld-attribution-readable-gap`
...
- v20.4.42 兩層 attribution 已 QA 通過；若 Owner 要更精細的 gate 排名或所有 AVOID+NORMAL 文案一致性，另開 attribution ranking/wording 任務，不在本輪改策略。
- v20.4.42 本輪報文可讀性修復已 QA 通過並完成收口；下一步只剩 Render freshness production log follow-up。
