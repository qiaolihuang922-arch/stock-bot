...
- task_md_task_id: `phase3-evidence-automation-20260602`
...
- Owner major 指令下一步：Phase 1/2/2b evidence_score / final_confidence / funnel modifier major；保留 fail-closed、透明拆分、不單獨造 BUY、不放寬追高。
