...
- task_md_task_id: `evidence-score-decision-funnel-phase1-2-2b`
...
- Owner major 指令已完成 Phase 1/2/2b；下一步若繼續，優先看 production evidence 資料品質 / per-stock evidence granularity，而不是再改手機文案。
