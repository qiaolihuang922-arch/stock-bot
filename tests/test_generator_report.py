...
class GeneratorReportTest(unittest.TestCase):
    ...
    def test_unheld_cards_follow_summary_group_order(self):
        ...
        self.assertIn("淘汰：1 檔｜主因：個股弱勢", summary_msg)
    ...
    def test_afterhours_brief_does_not_call_all_risk_today_buys_established_new_positions(self):
        ...
        self.assertIn("今日買入紀錄 2（已風控 2）", summary)
        self.assertIn("結論：今日買入紀錄 2 檔，已全部轉入風控/停損減碼；新增有效進場：無。", summary)
        self.assertIn("今日買入紀錄後風控：2 檔（", summary)
    ...
    def test_v20_0_14_post_market_fixture_uses_next_day_plan_semantics(self):
        ...
        self.assertIn("市場：中性觀察 R2｜執行動作 0｜今日新建倉 0｜持倉風控 0｜未持倉 1（可準備1）", summary)
